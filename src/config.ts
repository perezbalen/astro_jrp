...
export const siteConfig: SiteConfig = {
  // Site Information
  // [CONFIG:SITE_URL]
  site: "https://joserafaelperez.com",
  // [CONFIG:SITE_TITLE]
  ...
  defaultOgImageAlt: "Atari logo.", // Alt text for the default Open Graph image, public/open-graph.png
  ...
  customThemeFile: "yellow-theme", // Only used if theme is set to "custom" above. Filename in src/themes/custom/ (without .ts extension)
